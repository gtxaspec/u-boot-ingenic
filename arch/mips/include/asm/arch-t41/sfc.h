...
#define	DEV_CONF_SMP_DELAY_MSK		(0x1f << DEV_CONF_SMP_DELAY_OFFSET) //T41 0x3->0x1f
...
//For SFC_TRAN_CONF0
#define	TRAN_CONF0_CLK_OFFSET			(29) //T41 MODE->CLK
#define	TRAN_CONF0_CLK_MSK				(0x7 << TRAN_CONF0_CLK_OFFSET) //T41 MODE->CLK
...
#define TRAN_CONF1_TRAN_MODE_OFFSET		(4) //T41 CONFIG0->CONFIG1
#define TRAN_CONF1_TRAN_MODE_MSK		(0xf << TRAN_CONF1_TRAN_MODE_OFFSET) //T41 CONFIG0->CONFIG1
