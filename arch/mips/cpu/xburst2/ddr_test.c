...
#define DMAC_DCMD_SAI (1<<23)
#define DMAC_DCMD_DAI (1<<22)
#define DMAC_DCMD_TIE (0<<1)
#define DMAC_DCCSR_EN (1)
#define DMAC_DCCSR_NDES (1<<31)
#define DMAC_DRSR_RS_AUTO 0x8
...
static void dma_nodesc_test(unsigned int dma_chan, unsigned int dma_src_addr, unsigned int dma_dst_addr, unsigned int size)
{
	...
	writel(DMAC_DCMD_SAI | DMAC_DCMD_DAI | DMAC_DCMD_TIE | (9<<16) | (4<<8 ) | (0<<0 )| (0<<2 ) | (0<<14) | (0<<12), dma_chan_base + CH_DCM);
